...
# 2. System deps: R build tools + Python, pip, venv, and compression/C libs
RUN echo 'Acquire::Retries "5"; Acquire::http::Timeout "60"; Acquire::https::Timeout "60";' \
  ...
  && apt-get install -y --no-install-recommends \
       ...
       # Compression libraries for pandas, numpy, etc.
       zlib1g-dev libbz2-dev liblzma-dev libpcre2-dev libdeflate-dev \
       # libzstd for newer formats if needed
       libzstd-dev \
...
# 6. Setup Python venv and install requirements
